...
export class TimetableConstraints extends jspb.Message {
  ...
  setPeriodinfoList(
    value: Array<TimetableConstraints.PeriodInfo>
  ): TimetableConstraints;
  addPeriodinfo(
    value?: TimetableConstraints.PeriodInfo,
    index?: number
  ...
  static toObject(
    ...
    msg: TimetableConstraints
  ): TimetableConstraints.AsObject;
...
export class AutoTimetableResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: AutoTimetableResponse
  ): AutoTimetableResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };

...
interface IAutoTimetablerService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  findBestTimetable: IAutoTimetablerService_IFindBestTimetable;
}

interface IAutoTimetablerService_IFindBestTimetable
  extends grpc.MethodDefinition<
    autotimetabler_pb.TimetableConstraints,
    autotimetabler_pb.AutoTimetableResponse
  > {
...
export interface IAutoTimetablerServer {
  findBestTimetable: grpc.handleUnaryCall<
    autotimetabler_pb.TimetableConstraints,
    autotimetabler_pb.AutoTimetableResponse
  >;
}
...
export interface IAutoTimetablerClient {
  findBestTimetable(
    request: autotimetabler_pb.TimetableConstraints,
    callback: (
      error: grpc.ServiceError | null,
      response: autotimetabler_pb.AutoTimetableResponse
    ) => void
...
export class AutoTimetablerClient
  extends grpc.Client
  implements IAutoTimetablerClient
{
  constructor(
    address: string,

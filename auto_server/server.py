...
def main():
    ...
    autotimetabler_pb2_grpc.add_AutoTimetablerServicer_to_server(  # add the servicer to the server
        AutoTimetablerServicer(), server
    )
    server.add_insecure_port("0.0.0.0:50051")  # add the port to the server
...
if __name__ == "__main__":
    logging.basicConfig()  # basic logging

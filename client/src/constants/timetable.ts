...
export const getAvailableTermDetails = async () => {
  ...
  // Check if the term data is already stored in local storage. If it is, use it.
  // This is to prevent unnecessary api calls. If it is not, make an api call to get the term data.
  ...
  try {
    ...
    // Store the term details in local storage, so that we don't have to make an api call
...
export const colors: string[] = [
  // array of colors for the timetable
  "#137786", // dark cyan
  "#a843a4", // light purple
  "#134e86", // light blue
  "#138652", // light green
...
export const getTimeZoneOffset = (
  ...
  const offset =
    (formattedSgDate.getHours() * 60 +
      formattedSgDate.getMinutes() -
...
export const unknownErrorMessage =
  "An unknown error has occurred, please hard refresh the page";

...
const privacyQuestions = [
  {
    title: 'What personal information does nusmods++ collect?',
    content: (
      <>
  ...
  {
    title: 'How does nusmods++ use the information it collects?',
    content: (
      <p>
        nusmods++ uses the information described in this Privacy Statement (i) internally, to analyze, develop and improve its
        products and services, and (ii) as set forth below in the “Will nusmods++ share any of the personal information it
        receives” section below.
      </p>
    ),
  },
  {
    title: 'Will nusmods++ share any of the personal information it receives?',
    content: (
      <>
        <p>
        ...
        <p>
          Protection of nusmods++ and Others: We may release personal information when we believe in good faith that release is
          necessary to comply with the law; enforce or apply our conditions of use and other agreements; or protect the rights,
          property, or safety of nusmods++, our employees, our users, or others. This includes exchanging information with other
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        under nusmods++’s control, and such links do not constitute an endorsement by nusmods++ of those other
        applications/websites or the services offered through them. The privacy and security practices of such third party
        application/websites linked to the Application are not covered by this Privacy Statement, and nusmods++ is not responsible
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          nusmods++ allows you to access the following information about you for the purpose of viewing, and in certain
  ...
  },
  {
    ...
    content: (
      <p>
        nusmods++ may amend this Privacy Statement from time to time. Use of information we collect now is subject to the Privacy
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        nusmods++@csesoc.org.au. We will make every effort to resolve your concerns.
      </p>
    ),
  },
];
  ...
  return (
    <>
      <StyledDialogBody gutterBottom variant="body2">
        ...
        by nusmods++ (and may be provided by nusmods++ on behalf of a nusmods++ licensor or partner (“Application Partner”). By
      ...
      <FooterText gutterBottom variant="body2">
        Effective Date: 6<sup>th</sup> July, 2023
      </FooterText>
    </>
  );
};
